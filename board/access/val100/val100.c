...
#define ID_PAD_CTRL  (PAD_CTL_SPEED_MED | PAD_CTL_DSE_40ohm |			\
	PAD_CTL_SRE_FAST  | PAD_CTL_HYS)
...
static iomux_v3_cfg_t const board_detect[] = {
	...
	IOMUX_PADS(PAD_EIM_WAIT__GPIO5_IO00   | MUX_PAD_CTRL(ID_PAD_CTRL)),
	IOMUX_PADS(PAD_SD4_CLK__GPIO7_IO10   | MUX_PAD_CTRL(ID_PAD_CTRL)),
	IOMUX_PADS(PAD_SD4_CMD__GPIO7_IO09  | MUX_PAD_CTRL(ID_PAD_CTRL)),
	IOMUX_PADS(PAD_ENET_RX_ER__GPIO1_IO24 | MUX_PAD_CTRL(ID_PAD_CTRL)),
};
